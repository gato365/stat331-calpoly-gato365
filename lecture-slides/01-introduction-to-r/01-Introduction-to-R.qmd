...
+ Introduction
  + You + Intro to Me + the course + Ice Breaker (two truths and 1 lie)
  + Syllabus + Contracts
  + Intro to R + RStudio
  + Directories & File Paths
+ Troubleshooting
+ [PA 1: Find the Mistakes](https://gato365.github.io/stat331-calpoly-gato365/practice-activities/PA1-find-the-mistakes.html)

# Introductions


## `r fontawesome::fa("hand")` Hi, I'm Dr. Williams!
...
# [Syllabus](https://gato365.github.io/stat331-calpoly-gato365/00-course-info/syllabus-W2024.html)
...
# [Setting up an RStudio Project](https://gato365.github.io/stat331-calpoly-text/01-introduction.html#rprojects)
...
+ **PA 1: Find the Mistakes**
  + Due Thursday (1/12) at 8:00am <span style="color: red;"><strong>Only this time</strong></span>
...
## [Lab 1: Introduction to Quarto](https://gato365.github.io/stat331-calpoly-gato365/lab-assignments/Lab1/Lab1-intro-to-quarto.html)
