...
-   [PA 2: Using Data Visualization to Find the Penguins](https://gato365.github.io/stat331-calpoly-gato365/practice-activities/PA2-ggplot-palmer-penguins.html)
...
## APIs in Statistical Computing

### Utilizing APIs for Data Access
...
![](images/rest_api_works.png){fig-align="center" width="588"}
...
-   *Spotify API*
    -   Analyze music trends and user habits with the `spotifyr` package, directly interfacing with Spotify's Web API.
-   *Finance Data API*
    -   Access historical stock prices and financial statements using the `tidyquant` package, integrating with financial markets data.
-   *Census Data API*
    -   Retrieve demographics and population statistics with the `tidycensus` package, simplifying the use of US Census Bureau data.
-   *Sports Data API*
    -   Collect sports statistics and performance metrics. For example, use custom-built APIs or data access tools for platforms like Sports Reference.
...
![](images/ggplot_process.png){fig-align="center" width="588"}
...
![](images/layers.png){fig-align="center" width="400"}
...
![](images/position_adjustments.png){fig-align="center" width="100"}
...
![](images/gestalt_principles.jpg){fig-align="center" width="500"}
...
-   To “colorblind-proof” a graphic, you can use a couple of strategies:
    ...
    -   \small{If you have a bidirectional scale (e.g. showing positive and negative values), the safest scheme to use is purple - white - orange. In any color scale that is multi-hue, it is important to transition through white, instead of from one color to another directly.}
-   \small{Be conscious of what certain colors “mean”}
...
[Lab 2: Exploring Rodents with ggplot2](https://gato365.github.io/stat331-calpoly-gato365/lab-assignments/Lab2-graphics/lab2-exploring-rodents-with-ggplot2.html)
